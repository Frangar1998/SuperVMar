                ...
                <div className="row">
                    <div className="col-6">
                        <p className="text-white mb-0">
                            Envíos gratis por encima de 50€
                        </p>
                    </div>
                    <div className="col-6">
                        <p className="text-end text-white mb-0">
                            Teléfono:
                            <a className="text-white" href="tel:+34 664788445">
                                +34 664788445
                            </a>
                        </p>
                    </div>
        ...
        <header className="header-upper py-3">
            <div className="container-xxl">
                <div className="row align-items-center">
                    <div className="col-2">
                        <h2>
                            <Link className="text-white">SuperUbemar</Link>
                        </h2>
                    </div>
                    <div className="col-5">
                    ...
                    <div className="col-5">
                        <div className="header-upper-links d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <Link className="d-flex align-items-center gap-10 text-white">
                                    <img src="images/wishlist.svg" alt="Lista de deseados" />
                                    <p className="mb-0">
                                        Lista de <br /> deseados
                                    </p>
                                </Link>
                            </div>
                            <div>
                            ...
                            <div>
                                <Link className="d-flex align-items-center gap-10 text-white">
                                    <img src="images/cart.svg" alt="carro" />
